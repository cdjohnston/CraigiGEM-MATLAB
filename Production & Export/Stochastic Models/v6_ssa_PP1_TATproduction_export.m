...
% figure(3) - TatAconstructs vs PP1peri
...
figure(3);
        ...
        for p=1:30:571
                    plot(number_TatAconstructs(p),var_PP1peri(p,1),'--rs','MarkerEdgeColor','k','MarkerFaceColor',[1.000,0.525,0.365],'MarkerSize',10)
        end
        
% figure(4) - TatAconstructs vs Mass of Cells
...
figure(4);
        ...
        for p=1:30:571
                    plot(number_TatAconstructs(p),mass_cells(p,1),'--rs','MarkerEdgeColor','k','MarkerFaceColor',[1.000,0.525,0.365],'MarkerSize',10)
        end
